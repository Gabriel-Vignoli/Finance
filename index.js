...
function createTransactionAmount(amount) {
    ...
    //vai formatar valores numéricos em moedas brasileiras
...
async function saveTransaction(ev) {
    ...
    if (id) {
        //vai editar uma transação com esse id
        ...
        const indexToRemove = transactions.findIndex((t) => t.id == id) // Using '==' to compare string and number
